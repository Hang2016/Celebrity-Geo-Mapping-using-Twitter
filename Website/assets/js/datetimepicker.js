    ...
    **/
    ...
    PickerHandler.prototype._relocate = function () {
        ...
        if ($input != null && $picker.data('isInline') === false) { // Float mode
            ...
            $picker.parent().css('left', (($input.offset().left + $input.outerWidth()) - 319) + 'px');
        ...
        return this.each(function (i) {
            ...
            $(input).keyup(function () {
                ...
                if ($input.val() != null && (
                        ...
                        ($input.data('beforeVal') != null && $input.data('beforeVal') != $input.val()))) { /* beforeValue == null || beforeValue != nowValue  */
